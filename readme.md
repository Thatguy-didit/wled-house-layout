...
> This repository contains a modified WLED 16.0.0 build with a custom House
> Layout UI for architectural light mapping. See `CUSTOM_BUILD.md`,
> `COMPLIANCE.md`, and `CUSTOMER_SOURCE_NOTICE.md` before distributing firmware

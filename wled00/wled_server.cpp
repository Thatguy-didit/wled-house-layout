...
void initServer()
{
  ...
  static const char _housemap_htm[] PROGMEM = "/housemap.htm";
  server.on(_housemap_htm, HTTP_GET, [](AsyncWebServerRequest *request) {
    handleStaticContent(request, FPSTR(_housemap_htm), 200, FPSTR(CONTENT_TYPE_HTML), PAGE_housemap, PAGE_housemap_length);
  });
